...
export default function FooterLayout() {
    return (
        <div>
            <footer className="footer bg-white pt-8 pb-[26px] md:pt-12 md:pb-[36px] lg:pb-[46px] xl:pt-20">
                <div className="container footer__container flex flex-col justify-center items-center px-4 md:px-[32px] lg:px-4">
                    ...
                    <hr className="footer__hr w-full h-[2px] bg-[#1A367C] my-[26px] md:my-[36px] lg:my-[46px]" />
                    <FooterBottom />
                </div>
            </footer>
        </div>
